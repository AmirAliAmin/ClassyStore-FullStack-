        ...
        <div className='container'>
            <div className='card shadow-md w-[500px] m-auto rounded-md bg-white p-4'>
                ...
                <div className='my-5 space-y-3'>
                    <input type="text" className=' w-full py-3 border border-gray-500 outline-none px-3 rounded-md' placeholder='Email Id' />
                ...
                <h1 className='font-medium text-[14px]'>Forgot Password?</h1>
